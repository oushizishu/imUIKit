...
#pragma mark - gesture
- (void)handleTouchBegan:(CGPoint)touchLocation
{
...
- (void)handleTouchCancelled:(CGPoint)touchLocation
{
...
- (void)tapAction:(UIGestureRecognizer *)ges
{
    ...
    switch (ges.state) {
        ...
        case UIGestureRecognizerStateEnded: {
            [self handleTouchEnded:touchLocation];
            break;
        }
        case UIGestureRecognizerStateCancelled: {
            [self handleTouchCancelled:touchLocation];
            break;
        }
