...
- (void)setPlaceHolder:(NSString *)placeHolder {
    ...
    NSUInteger maxChars = [BJMessageTextView maxCharactersPerLine];
...
- (NSUInteger)numberOfLinesOfText {
    return [BJMessageTextView numberOfLinesForMessage:self.text];
}
...
+ (NSUInteger)numberOfLinesForMessage:(NSString *)text {
    return (text.length / [BJMessageTextView maxCharactersPerLine]) + 1;
}
